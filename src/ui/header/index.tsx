      ...
      <nav>
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
          ...
          >
            ...
            <span className="cursor-pointer self-center whitespace-nowrap text-Body-2 font-semibold text-gray-light-600 hover:text-gray-light-900 dark:text-gray-dark-600 hover:dark:text-gray-dark-900">
              Reactomancer
            </span>
          </a>
          <button
